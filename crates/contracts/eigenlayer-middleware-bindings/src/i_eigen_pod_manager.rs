...
pub mod i_eigen_pod_manager {
    ...
    pub static IEIGENPODMANAGER_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct IEigenPodManager<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IEigenPodManager<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IEigenPodManager<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IEigenPodManager<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IEigenPodManager<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IEigenPodManager))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IEigenPodManager<M> {
        ...
        > {
            self.0
                .method_hash([155, 160, 98, 117], pod_owner)
                .expect("method not found (this should never happen)")
        }
    ...
    impl ::ethers::contract::EthLogDecode for IEigenPodManagerEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = BeaconChainETHDepositedFilter::decode_log(log) {
                return Ok(
                    IEigenPodManagerEvents::BeaconChainETHDepositedFilter(decoded),
                );
            }
            if let Ok(decoded) = BeaconChainETHWithdrawalCompletedFilter::decode_log(
                ...
                return Ok(
                    IEigenPodManagerEvents::BeaconChainETHWithdrawalCompletedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = BeaconOracleUpdatedFilter::decode_log(log) {
                return Ok(IEigenPodManagerEvents::BeaconOracleUpdatedFilter(decoded));
            }
            if let Ok(decoded) = DenebForkTimestampUpdatedFilter::decode_log(log) {
                return Ok(
                    IEigenPodManagerEvents::DenebForkTimestampUpdatedFilter(decoded),
                );
            }
            if let Ok(decoded) = MaxPodsUpdatedFilter::decode_log(log) {
                return Ok(IEigenPodManagerEvents::MaxPodsUpdatedFilter(decoded));
            }
            if let Ok(decoded) = PausedFilter::decode_log(log) {
                return Ok(IEigenPodManagerEvents::PausedFilter(decoded));
            }
            if let Ok(decoded) = PauserRegistrySetFilter::decode_log(log) {
                return Ok(IEigenPodManagerEvents::PauserRegistrySetFilter(decoded));
            }
            if let Ok(decoded) = PodDeployedFilter::decode_log(log) {
                return Ok(IEigenPodManagerEvents::PodDeployedFilter(decoded));
            }
            if let Ok(decoded) = PodSharesUpdatedFilter::decode_log(log) {
                return Ok(IEigenPodManagerEvents::PodSharesUpdatedFilter(decoded));
            }
            if let Ok(decoded) = UnpausedFilter::decode_log(log) {
                return Ok(IEigenPodManagerEvents::UnpausedFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for IEigenPodManagerEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<BeaconOracleUpdatedFilter> for IEigenPodManagerEvents {
    ...
    impl ::core::convert::From<MaxPodsUpdatedFilter> for IEigenPodManagerEvents {
        fn from(value: MaxPodsUpdatedFilter) -> Self {
            Self::MaxPodsUpdatedFilter(value)
        }
    }
    impl ::core::convert::From<PausedFilter> for IEigenPodManagerEvents {
        fn from(value: PausedFilter) -> Self {
            Self::PausedFilter(value)
        }
    }
    impl ::core::convert::From<PauserRegistrySetFilter> for IEigenPodManagerEvents {
        fn from(value: PauserRegistrySetFilter) -> Self {
            Self::PauserRegistrySetFilter(value)
        }
    }
    impl ::core::convert::From<PodDeployedFilter> for IEigenPodManagerEvents {
        fn from(value: PodDeployedFilter) -> Self {
            Self::PodDeployedFilter(value)
        }
    }
    impl ::core::convert::From<PodSharesUpdatedFilter> for IEigenPodManagerEvents {
        fn from(value: PodSharesUpdatedFilter) -> Self {
            Self::PodSharesUpdatedFilter(value)
        }
    }
    impl ::core::convert::From<UnpausedFilter> for IEigenPodManagerEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for IEigenPodManagerCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IEigenPodManagerCalls {
    ...
    impl ::core::fmt::Display for IEigenPodManagerCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AddSharesCall> for IEigenPodManagerCalls {
        fn from(value: AddSharesCall) -> Self {
            Self::AddShares(value)
        }
    }
    impl ::core::convert::From<BeaconChainETHStrategyCall> for IEigenPodManagerCalls {
        fn from(value: BeaconChainETHStrategyCall) -> Self {
            Self::BeaconChainETHStrategy(value)
        }
    }
    impl ::core::convert::From<BeaconChainOracleCall> for IEigenPodManagerCalls {
        fn from(value: BeaconChainOracleCall) -> Self {
            Self::BeaconChainOracle(value)
        }
    }
    impl ::core::convert::From<CreatePodCall> for IEigenPodManagerCalls {
        fn from(value: CreatePodCall) -> Self {
            Self::CreatePod(value)
        }
    }
    impl ::core::convert::From<DenebForkTimestampCall> for IEigenPodManagerCalls {
        fn from(value: DenebForkTimestampCall) -> Self {
            Self::DenebForkTimestamp(value)
        }
    }
    impl ::core::convert::From<EigenPodBeaconCall> for IEigenPodManagerCalls {
        fn from(value: EigenPodBeaconCall) -> Self {
            Self::EigenPodBeacon(value)
        }
    }
    impl ::core::convert::From<EthPOSCall> for IEigenPodManagerCalls {
        fn from(value: EthPOSCall) -> Self {
            Self::EthPOS(value)
        }
    }
    impl ::core::convert::From<GetBlockRootAtTimestampCall> for IEigenPodManagerCalls {
        fn from(value: GetBlockRootAtTimestampCall) -> Self {
            Self::GetBlockRootAtTimestamp(value)
        }
    }
    impl ::core::convert::From<GetPodCall> for IEigenPodManagerCalls {
        fn from(value: GetPodCall) -> Self {
            Self::GetPod(value)
        }
    }
    impl ::core::convert::From<HasPodCall> for IEigenPodManagerCalls {
        fn from(value: HasPodCall) -> Self {
            Self::HasPod(value)
        }
    }
    impl ::core::convert::From<MaxPodsCall> for IEigenPodManagerCalls {
        fn from(value: MaxPodsCall) -> Self {
            Self::MaxPods(value)
        }
    }
    impl ::core::convert::From<NumPodsCall> for IEigenPodManagerCalls {
        fn from(value: NumPodsCall) -> Self {
            Self::NumPods(value)
        }
    }
    impl ::core::convert::From<OwnerToPodCall> for IEigenPodManagerCalls {
        fn from(value: OwnerToPodCall) -> Self {
            Self::OwnerToPod(value)
        }
    }
    impl ::core::convert::From<PauseCall> for IEigenPodManagerCalls {
        fn from(value: PauseCall) -> Self {
            Self::Pause(value)
        }
    }
    impl ::core::convert::From<PauseAllCall> for IEigenPodManagerCalls {
        fn from(value: PauseAllCall) -> Self {
            Self::PauseAll(value)
        }
    }
    impl ::core::convert::From<PausedWithIndexCall> for IEigenPodManagerCalls {
        fn from(value: PausedWithIndexCall) -> Self {
            Self::PausedWithIndex(value)
        }
    }
    impl ::core::convert::From<PausedCall> for IEigenPodManagerCalls {
        fn from(value: PausedCall) -> Self {
            Self::Paused(value)
        }
    }
    impl ::core::convert::From<PauserRegistryCall> for IEigenPodManagerCalls {
        fn from(value: PauserRegistryCall) -> Self {
            Self::PauserRegistry(value)
        }
    }
    impl ::core::convert::From<PodOwnerSharesCall> for IEigenPodManagerCalls {
    ...
    for IEigenPodManagerCalls {
        fn from(value: RecordBeaconChainETHBalanceUpdateCall) -> Self {
            Self::RecordBeaconChainETHBalanceUpdate(value)
        }
    }
    impl ::core::convert::From<RemoveSharesCall> for IEigenPodManagerCalls {
        fn from(value: RemoveSharesCall) -> Self {
            Self::RemoveShares(value)
        }
    }
    impl ::core::convert::From<SetDenebForkTimestampCall> for IEigenPodManagerCalls {
        fn from(value: SetDenebForkTimestampCall) -> Self {
            Self::SetDenebForkTimestamp(value)
        }
    }
    impl ::core::convert::From<SetPauserRegistryCall> for IEigenPodManagerCalls {
        fn from(value: SetPauserRegistryCall) -> Self {
            Self::SetPauserRegistry(value)
        }
    }
    impl ::core::convert::From<SlasherCall> for IEigenPodManagerCalls {
        fn from(value: SlasherCall) -> Self {
            Self::Slasher(value)
        }
    }
    impl ::core::convert::From<StakeCall> for IEigenPodManagerCalls {
        fn from(value: StakeCall) -> Self {
            Self::Stake(value)
        }
    }
    impl ::core::convert::From<StrategyManagerCall> for IEigenPodManagerCalls {
        fn from(value: StrategyManagerCall) -> Self {
            Self::StrategyManager(value)
        }
    }
    impl ::core::convert::From<UnpauseCall> for IEigenPodManagerCalls {
        fn from(value: UnpauseCall) -> Self {
            Self::Unpause(value)
        }
    }
    impl ::core::convert::From<UpdateBeaconChainOracleCall> for IEigenPodManagerCalls {
        fn from(value: UpdateBeaconChainOracleCall) -> Self {
            Self::UpdateBeaconChainOracle(value)
        }
    }
    impl ::core::convert::From<WithdrawSharesAsTokensCall> for IEigenPodManagerCalls {
