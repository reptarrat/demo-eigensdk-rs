pub use registry_coordinator_storage::*;
...
pub mod registry_coordinator_storage {
    ...
    pub static REGISTRYCOORDINATORSTORAGE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct RegistryCoordinatorStorage<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for RegistryCoordinatorStorage<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for RegistryCoordinatorStorage<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for RegistryCoordinatorStorage<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for RegistryCoordinatorStorage<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(RegistryCoordinatorStorage))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> RegistryCoordinatorStorage<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    REGISTRYCOORDINATORSTORAGE_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            RegistryCoordinatorStorageEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for RegistryCoordinatorStorage<M> {
    ...
    impl ::ethers::contract::EthLogDecode for RegistryCoordinatorStorageEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ChurnApproverUpdatedFilter::decode_log(log) {
                return Ok(
                    RegistryCoordinatorStorageEvents::ChurnApproverUpdatedFilter(decoded),
                );
            }
            if let Ok(decoded) = EjectorUpdatedFilter::decode_log(log) {
                return Ok(
                    RegistryCoordinatorStorageEvents::EjectorUpdatedFilter(decoded),
                );
            }
            if let Ok(decoded) = OperatorDeregisteredFilter::decode_log(log) {
                return Ok(
                    RegistryCoordinatorStorageEvents::OperatorDeregisteredFilter(decoded),
                );
            }
            if let Ok(decoded) = OperatorRegisteredFilter::decode_log(log) {
                return Ok(
                    RegistryCoordinatorStorageEvents::OperatorRegisteredFilter(decoded),
                );
            }
            if let Ok(decoded) = OperatorSetParamsUpdatedFilter::decode_log(log) {
                return Ok(
                    RegistryCoordinatorStorageEvents::OperatorSetParamsUpdatedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = QuorumBlockNumberUpdatedFilter::decode_log(log) {
                return Ok(
                    RegistryCoordinatorStorageEvents::QuorumBlockNumberUpdatedFilter(
                        decoded,
                    ),
                );
            }
    ...
    impl ::core::fmt::Display for RegistryCoordinatorStorageEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for RegistryCoordinatorStorageEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for RegistryCoordinatorStorageCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for RegistryCoordinatorStorageCalls {
    ...
    impl ::core::fmt::Display for RegistryCoordinatorStorageCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::OperatorChurnApprovalTypehash(element) => {
                    ::core::fmt::Display::fmt(element, f)
    ...
    for RegistryCoordinatorStorageCalls {
    ...
    impl ::core::convert::From<BlsApkRegistryCall> for RegistryCoordinatorStorageCalls {
        fn from(value: BlsApkRegistryCall) -> Self {
            Self::BlsApkRegistry(value)
        }
    }
    impl ::core::convert::From<ChurnApproverCall> for RegistryCoordinatorStorageCalls {
    ...
    impl ::core::convert::From<GetOperatorCall> for RegistryCoordinatorStorageCalls {
    ...
    impl ::core::convert::From<GetOperatorIdCall> for RegistryCoordinatorStorageCalls {
    ...
    impl ::core::convert::From<IndexRegistryCall> for RegistryCoordinatorStorageCalls {
    ...
    impl ::core::convert::From<OwnerCall> for RegistryCoordinatorStorageCalls {
    ...
    impl ::core::convert::From<QuorumCountCall> for RegistryCoordinatorStorageCalls {
    ...
    impl ::core::convert::From<RegistriesCall> for RegistryCoordinatorStorageCalls {
        fn from(value: RegistriesCall) -> Self {
            Self::Registries(value)
        }
    }
    impl ::core::convert::From<ServiceManagerCall> for RegistryCoordinatorStorageCalls {
        fn from(value: ServiceManagerCall) -> Self {
            Self::ServiceManager(value)
        }
    }
    impl ::core::convert::From<StakeRegistryCall> for RegistryCoordinatorStorageCalls {
