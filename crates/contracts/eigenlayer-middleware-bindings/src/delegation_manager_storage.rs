pub use delegation_manager_storage::*;
...
pub mod delegation_manager_storage {
    ...
    pub static DELEGATIONMANAGERSTORAGE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct DelegationManagerStorage<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for DelegationManagerStorage<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for DelegationManagerStorage<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for DelegationManagerStorage<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for DelegationManagerStorage<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(DelegationManagerStorage))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> DelegationManagerStorage<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    DELEGATIONMANAGERSTORAGE_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            DelegationManagerStorageEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for DelegationManagerStorage<M> {
    ...
    impl ::ethers::contract::EthLogDecode for DelegationManagerStorageEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = MinWithdrawalDelayBlocksSetFilter::decode_log(log) {
                return Ok(
                    DelegationManagerStorageEvents::MinWithdrawalDelayBlocksSetFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = OperatorDetailsModifiedFilter::decode_log(log) {
                return Ok(
                    DelegationManagerStorageEvents::OperatorDetailsModifiedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = OperatorMetadataURIUpdatedFilter::decode_log(log) {
                return Ok(
                    DelegationManagerStorageEvents::OperatorMetadataURIUpdatedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = OperatorRegisteredFilter::decode_log(log) {
                return Ok(
                    DelegationManagerStorageEvents::OperatorRegisteredFilter(decoded),
                );
            }
            if let Ok(decoded) = OperatorSharesDecreasedFilter::decode_log(log) {
                return Ok(
                    DelegationManagerStorageEvents::OperatorSharesDecreasedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = OperatorSharesIncreasedFilter::decode_log(log) {
                return Ok(
                    DelegationManagerStorageEvents::OperatorSharesIncreasedFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = StakerDelegatedFilter::decode_log(log) {
                return Ok(
                    DelegationManagerStorageEvents::StakerDelegatedFilter(decoded),
                );
            }
            if let Ok(decoded) = StakerForceUndelegatedFilter::decode_log(log) {
                return Ok(
                    DelegationManagerStorageEvents::StakerForceUndelegatedFilter(decoded),
                );
            }
            if let Ok(decoded) = StakerUndelegatedFilter::decode_log(log) {
                return Ok(
                    DelegationManagerStorageEvents::StakerUndelegatedFilter(decoded),
                );
            }
            if let Ok(decoded) = StrategyWithdrawalDelayBlocksSetFilter::decode_log(
                ...
                return Ok(
                    DelegationManagerStorageEvents::StrategyWithdrawalDelayBlocksSetFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = WithdrawalCompletedFilter::decode_log(log) {
                return Ok(
                    DelegationManagerStorageEvents::WithdrawalCompletedFilter(decoded),
                );
            }
            if let Ok(decoded) = WithdrawalMigratedFilter::decode_log(log) {
                return Ok(
                    DelegationManagerStorageEvents::WithdrawalMigratedFilter(decoded),
                );
            }
            if let Ok(decoded) = WithdrawalQueuedFilter::decode_log(log) {
                return Ok(
                    DelegationManagerStorageEvents::WithdrawalQueuedFilter(decoded),
                );
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for DelegationManagerStorageEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    for DelegationManagerStorageEvents {
    ...
    impl ::core::convert::From<StakerDelegatedFilter>
    for DelegationManagerStorageEvents {
    ...
    impl ::core::convert::From<StakerUndelegatedFilter>
    for DelegationManagerStorageEvents {
    ...
    impl ::core::convert::From<WithdrawalQueuedFilter>
    for DelegationManagerStorageEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for DelegationManagerStorageCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for DelegationManagerStorageCalls {
    ...
    impl ::core::fmt::Display for DelegationManagerStorageCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::DelegationApprovalTypehash(element) => {
                    ::core::fmt::Display::fmt(element, f)
    ...
    for DelegationManagerStorageCalls {
        fn from(value: DelegationApprovalTypehashCall) -> Self {
            Self::DelegationApprovalTypehash(value)
        }
    }
    impl ::core::convert::From<DomainTypehashCall> for DelegationManagerStorageCalls {
    ...
    impl ::core::convert::From<DelegateToCall> for DelegationManagerStorageCalls {
    ...
    impl ::core::convert::From<DelegatedToCall> for DelegationManagerStorageCalls {
    ...
    impl ::core::convert::From<DomainSeparatorCall> for DelegationManagerStorageCalls {
        fn from(value: DomainSeparatorCall) -> Self {
            Self::DomainSeparator(value)
        }
    }
    impl ::core::convert::From<EarningsReceiverCall> for DelegationManagerStorageCalls {
        fn from(value: EarningsReceiverCall) -> Self {
            Self::EarningsReceiver(value)
        }
    }
    impl ::core::convert::From<EigenPodManagerCall> for DelegationManagerStorageCalls {
        fn from(value: EigenPodManagerCall) -> Self {
            Self::EigenPodManager(value)
        }
    }
    impl ::core::convert::From<GetOperatorSharesCall> for DelegationManagerStorageCalls {
    ...
    impl ::core::convert::From<IsDelegatedCall> for DelegationManagerStorageCalls {
        fn from(value: IsDelegatedCall) -> Self {
            Self::IsDelegated(value)
        }
    }
    impl ::core::convert::From<IsOperatorCall> for DelegationManagerStorageCalls {
    ...
    impl ::core::convert::From<OperatorDetailsCall> for DelegationManagerStorageCalls {
        fn from(value: OperatorDetailsCall) -> Self {
            Self::OperatorDetails(value)
        }
    }
    impl ::core::convert::From<OperatorSharesCall> for DelegationManagerStorageCalls {
    ...
    impl ::core::convert::From<QueueWithdrawalsCall> for DelegationManagerStorageCalls {
    ...
    impl ::core::convert::From<SlasherCall> for DelegationManagerStorageCalls {
        fn from(value: SlasherCall) -> Self {
            Self::Slasher(value)
        }
    }
    impl ::core::convert::From<StakerNonceCall> for DelegationManagerStorageCalls {
    ...
    impl ::core::convert::From<StrategyManagerCall> for DelegationManagerStorageCalls {
    ...
    impl ::core::convert::From<UndelegateCall> for DelegationManagerStorageCalls {
