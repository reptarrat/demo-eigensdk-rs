...
pub mod ibls_apk_registry {
    ...
    pub static IBLSAPKREGISTRY_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct IBLSApkRegistry<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IBLSApkRegistry<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IBLSApkRegistry<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IBLSApkRegistry<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IBLSApkRegistry<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IBLSApkRegistry))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IBLSApkRegistry<M> {
    ...
    impl ::ethers::contract::EthLogDecode for IBLSApkRegistryEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = NewPubkeyRegistrationFilter::decode_log(log) {
                return Ok(IBLSApkRegistryEvents::NewPubkeyRegistrationFilter(decoded));
            }
            if let Ok(decoded) = OperatorAddedToQuorumsFilter::decode_log(log) {
                return Ok(IBLSApkRegistryEvents::OperatorAddedToQuorumsFilter(decoded));
            }
            if let Ok(decoded) = OperatorRemovedFromQuorumsFilter::decode_log(log) {
                return Ok(
                    IBLSApkRegistryEvents::OperatorRemovedFromQuorumsFilter(decoded),
                );
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for IBLSApkRegistryEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<NewPubkeyRegistrationFilter> for IBLSApkRegistryEvents {
        fn from(value: NewPubkeyRegistrationFilter) -> Self {
            Self::NewPubkeyRegistrationFilter(value)
        }
    }
    impl ::core::convert::From<OperatorAddedToQuorumsFilter> for IBLSApkRegistryEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for IBLSApkRegistryCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IBLSApkRegistryCalls {
    ...
    impl ::core::fmt::Display for IBLSApkRegistryCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::DeregisterOperator(element) => {
                    ::core::fmt::Display::fmt(element, f)
    ...
    impl ::core::convert::From<DeregisterOperatorCall> for IBLSApkRegistryCalls {
        fn from(value: DeregisterOperatorCall) -> Self {
            Self::DeregisterOperator(value)
        }
    }
    impl ::core::convert::From<GetApkCall> for IBLSApkRegistryCalls {
        fn from(value: GetApkCall) -> Self {
            Self::GetApk(value)
        }
    }
    impl ::core::convert::From<GetApkHashAtBlockNumberAndIndexCall>
    for IBLSApkRegistryCalls {
        fn from(value: GetApkHashAtBlockNumberAndIndexCall) -> Self {
            Self::GetApkHashAtBlockNumberAndIndex(value)
        }
    }
    impl ::core::convert::From<GetApkIndicesAtBlockNumberCall> for IBLSApkRegistryCalls {
        fn from(value: GetApkIndicesAtBlockNumberCall) -> Self {
            Self::GetApkIndicesAtBlockNumber(value)
        }
    }
    impl ::core::convert::From<GetApkUpdateAtIndexCall> for IBLSApkRegistryCalls {
        fn from(value: GetApkUpdateAtIndexCall) -> Self {
            Self::GetApkUpdateAtIndex(value)
        }
    }
    impl ::core::convert::From<GetOperatorFromPubkeyHashCall> for IBLSApkRegistryCalls {
        fn from(value: GetOperatorFromPubkeyHashCall) -> Self {
            Self::GetOperatorFromPubkeyHash(value)
        }
    }
    impl ::core::convert::From<GetOperatorIdCall> for IBLSApkRegistryCalls {
        fn from(value: GetOperatorIdCall) -> Self {
            Self::GetOperatorId(value)
        }
    }
    impl ::core::convert::From<GetRegisteredPubkeyCall> for IBLSApkRegistryCalls {
        fn from(value: GetRegisteredPubkeyCall) -> Self {
            Self::GetRegisteredPubkey(value)
        }
    }
    impl ::core::convert::From<InitializeQuorumCall> for IBLSApkRegistryCalls {
        fn from(value: InitializeQuorumCall) -> Self {
            Self::InitializeQuorum(value)
        }
    }
    impl ::core::convert::From<OperatorToPubkeyHashCall> for IBLSApkRegistryCalls {
        fn from(value: OperatorToPubkeyHashCall) -> Self {
            Self::OperatorToPubkeyHash(value)
        }
    }
    impl ::core::convert::From<PubkeyHashToOperatorCall> for IBLSApkRegistryCalls {
        fn from(value: PubkeyHashToOperatorCall) -> Self {
            Self::PubkeyHashToOperator(value)
        }
    }
    impl ::core::convert::From<RegisterBLSPublicKeyCall> for IBLSApkRegistryCalls {
        fn from(value: RegisterBLSPublicKeyCall) -> Self {
            Self::RegisterBLSPublicKey(value)
        }
    }
    impl ::core::convert::From<RegisterOperatorCall> for IBLSApkRegistryCalls {
        fn from(value: RegisterOperatorCall) -> Self {
            Self::RegisterOperator(value)
        }
    }
    impl ::core::convert::From<RegistryCoordinatorCall> for IBLSApkRegistryCalls {
