...
pub mod i_delegation_manager {
    ...
    impl<M: ::ethers::providers::Middleware> IDelegationManager<M> {
        ...
        pub fn strategy_withdrawal_delay_blocks(
            ...
            self.0
                .method_hash([196, 136, 55, 90], strategy)
                .expect("method not found (this should never happen)")
        }
    ...
    impl ::ethers::contract::EthLogDecode for IDelegationManagerEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = MinWithdrawalDelayBlocksSetFilter::decode_log(log) {
                return Ok(
                    IDelegationManagerEvents::MinWithdrawalDelayBlocksSetFilter(decoded),
                );
            }
            ...
            if let Ok(decoded) = StrategyWithdrawalDelayBlocksSetFilter::decode_log(
                ...
                return Ok(
                    IDelegationManagerEvents::StrategyWithdrawalDelayBlocksSetFilter(
                        decoded,
                    ),
                );
            }
    ...
    impl ::core::convert::From<GetWithdrawalDelayCall> for IDelegationManagerCalls {
