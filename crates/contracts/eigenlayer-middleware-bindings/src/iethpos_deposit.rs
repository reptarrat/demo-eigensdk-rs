...
pub mod iethpos_deposit {
    ...
    pub static IETHPOSDEPOSIT_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    pub struct IETHPOSDeposit<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for IETHPOSDeposit<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for IETHPOSDeposit<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for IETHPOSDeposit<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for IETHPOSDeposit<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(IETHPOSDeposit))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> IETHPOSDeposit<M> {
    ...
    impl ::ethers::core::abi::AbiDecode for IETHPOSDepositCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for IETHPOSDepositCalls {
    ...
    impl ::core::fmt::Display for IETHPOSDepositCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<DepositCall> for IETHPOSDepositCalls {
        fn from(value: DepositCall) -> Self {
            Self::Deposit(value)
        }
    }
    impl ::core::convert::From<GetDepositCountCall> for IETHPOSDepositCalls {
        fn from(value: GetDepositCountCall) -> Self {
            Self::GetDepositCount(value)
        }
    }
    impl ::core::convert::From<GetDepositRootCall> for IETHPOSDepositCalls {
