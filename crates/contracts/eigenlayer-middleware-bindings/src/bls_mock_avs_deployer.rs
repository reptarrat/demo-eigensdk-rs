...
pub mod bls_mock_avs_deployer {
    ...
    impl<M: ::ethers::providers::Middleware> BLSMockAVSDeployer<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                BLSMOCKAVSDEPLOYER_ABI.clone(),
                BLSMOCKAVSDEPLOYER_BYTECODE.clone().into(),
                client,
            );
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            BLSMockAVSDeployerEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for BLSMockAVSDeployer<M> {
    ...
    impl ::ethers::contract::EthLogDecode for BLSMockAVSDeployerEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = LogFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogFilter(decoded));
            }
            if let Ok(decoded) = LogAddressFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogAddressFilter(decoded));
            }
            if let Ok(decoded) = LogArray1Filter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogArray1Filter(decoded));
            }
            if let Ok(decoded) = LogArray2Filter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogArray2Filter(decoded));
            }
            if let Ok(decoded) = LogArray3Filter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogArray3Filter(decoded));
            }
            if let Ok(decoded) = LogBytesFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogBytesFilter(decoded));
            }
            if let Ok(decoded) = LogBytes32Filter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogBytes32Filter(decoded));
            }
            if let Ok(decoded) = LogIntFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedAddressFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogNamedAddressFilter(decoded));
            }
            if let Ok(decoded) = LogNamedArray1Filter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogNamedArray1Filter(decoded));
            }
            if let Ok(decoded) = LogNamedArray2Filter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogNamedArray2Filter(decoded));
            }
            if let Ok(decoded) = LogNamedArray3Filter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogNamedArray3Filter(decoded));
            }
            if let Ok(decoded) = LogNamedBytesFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogNamedBytesFilter(decoded));
            }
            if let Ok(decoded) = LogNamedBytes32Filter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogNamedBytes32Filter(decoded));
            }
            if let Ok(decoded) = LogNamedDecimalIntFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogNamedDecimalIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedDecimalUintFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogNamedDecimalUintFilter(decoded));
            }
            if let Ok(decoded) = LogNamedIntFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogNamedIntFilter(decoded));
            }
            if let Ok(decoded) = LogNamedStringFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogNamedStringFilter(decoded));
            }
            if let Ok(decoded) = LogNamedUintFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogNamedUintFilter(decoded));
            }
            if let Ok(decoded) = LogStringFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogStringFilter(decoded));
            }
            if let Ok(decoded) = LogUintFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogUintFilter(decoded));
            }
            if let Ok(decoded) = LogsFilter::decode_log(log) {
                return Ok(BLSMockAVSDeployerEvents::LogsFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for BLSMockAVSDeployerEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<LogFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogFilter) -> Self {
            Self::LogFilter(value)
        }
    }
    impl ::core::convert::From<LogAddressFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogAddressFilter) -> Self {
            Self::LogAddressFilter(value)
        }
    }
    impl ::core::convert::From<LogArray1Filter> for BLSMockAVSDeployerEvents {
        fn from(value: LogArray1Filter) -> Self {
            Self::LogArray1Filter(value)
        }
    }
    impl ::core::convert::From<LogArray2Filter> for BLSMockAVSDeployerEvents {
        fn from(value: LogArray2Filter) -> Self {
            Self::LogArray2Filter(value)
        }
    }
    impl ::core::convert::From<LogArray3Filter> for BLSMockAVSDeployerEvents {
        fn from(value: LogArray3Filter) -> Self {
            Self::LogArray3Filter(value)
        }
    }
    impl ::core::convert::From<LogBytesFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogBytesFilter) -> Self {
            Self::LogBytesFilter(value)
        }
    }
    impl ::core::convert::From<LogBytes32Filter> for BLSMockAVSDeployerEvents {
        fn from(value: LogBytes32Filter) -> Self {
            Self::LogBytes32Filter(value)
        }
    }
    impl ::core::convert::From<LogIntFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogIntFilter) -> Self {
            Self::LogIntFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedAddressFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogNamedAddressFilter) -> Self {
            Self::LogNamedAddressFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedArray1Filter> for BLSMockAVSDeployerEvents {
        fn from(value: LogNamedArray1Filter) -> Self {
            Self::LogNamedArray1Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedArray2Filter> for BLSMockAVSDeployerEvents {
        fn from(value: LogNamedArray2Filter) -> Self {
            Self::LogNamedArray2Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedArray3Filter> for BLSMockAVSDeployerEvents {
        fn from(value: LogNamedArray3Filter) -> Self {
            Self::LogNamedArray3Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedBytesFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogNamedBytesFilter) -> Self {
            Self::LogNamedBytesFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedBytes32Filter> for BLSMockAVSDeployerEvents {
        fn from(value: LogNamedBytes32Filter) -> Self {
            Self::LogNamedBytes32Filter(value)
        }
    }
    impl ::core::convert::From<LogNamedDecimalIntFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogNamedDecimalIntFilter) -> Self {
            Self::LogNamedDecimalIntFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedDecimalUintFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogNamedDecimalUintFilter) -> Self {
            Self::LogNamedDecimalUintFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedIntFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogNamedIntFilter) -> Self {
            Self::LogNamedIntFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedStringFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogNamedStringFilter) -> Self {
            Self::LogNamedStringFilter(value)
        }
    }
    impl ::core::convert::From<LogNamedUintFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogNamedUintFilter) -> Self {
            Self::LogNamedUintFilter(value)
        }
    }
    impl ::core::convert::From<LogStringFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogStringFilter) -> Self {
            Self::LogStringFilter(value)
        }
    }
    impl ::core::convert::From<LogUintFilter> for BLSMockAVSDeployerEvents {
        fn from(value: LogUintFilter) -> Self {
            Self::LogUintFilter(value)
        }
    }
    impl ::core::convert::From<LogsFilter> for BLSMockAVSDeployerEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for BLSMockAVSDeployerCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for BLSMockAVSDeployerCalls {
    ...
    impl ::core::fmt::Display for BLSMockAVSDeployerCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<IsTestCall> for BLSMockAVSDeployerCalls {
        fn from(value: IsTestCall) -> Self {
            Self::IsTest(value)
        }
    }
    impl ::core::convert::From<WeightingDivisorCall> for BLSMockAVSDeployerCalls {
    ...
    impl ::core::convert::From<AvsDirectoryMockCall> for BLSMockAVSDeployerCalls {
        fn from(value: AvsDirectoryMockCall) -> Self {
            Self::AvsDirectoryMock(value)
        }
    }
    impl ::core::convert::From<BlsApkRegistryCall> for BLSMockAVSDeployerCalls {
    ...
    impl ::core::convert::From<DelegationMockCall> for BLSMockAVSDeployerCalls {
        fn from(value: DelegationMockCall) -> Self {
            Self::DelegationMock(value)
        }
    }
    impl ::core::convert::From<EigenPodManagerMockCall> for BLSMockAVSDeployerCalls {
        fn from(value: EigenPodManagerMockCall) -> Self {
            Self::EigenPodManagerMock(value)
        }
    }
    impl ::core::convert::From<EmptyContractCall> for BLSMockAVSDeployerCalls {
        fn from(value: EmptyContractCall) -> Self {
            Self::EmptyContract(value)
        }
    }
    impl ::core::convert::From<ExcludeArtifactsCall> for BLSMockAVSDeployerCalls {
        fn from(value: ExcludeArtifactsCall) -> Self {
            Self::ExcludeArtifacts(value)
        }
    }
    impl ::core::convert::From<ExcludeContractsCall> for BLSMockAVSDeployerCalls {
        fn from(value: ExcludeContractsCall) -> Self {
            Self::ExcludeContracts(value)
        }
    }
    impl ::core::convert::From<ExcludeSendersCall> for BLSMockAVSDeployerCalls {
        fn from(value: ExcludeSendersCall) -> Self {
            Self::ExcludeSenders(value)
        }
    }
    impl ::core::convert::From<FailedCall> for BLSMockAVSDeployerCalls {
        fn from(value: FailedCall) -> Self {
            Self::Failed(value)
        }
    }
    impl ::core::convert::From<IndexRegistryCall> for BLSMockAVSDeployerCalls {
    ...
    impl ::core::convert::From<OperatorStateRetrieverCall> for BLSMockAVSDeployerCalls {
        fn from(value: OperatorStateRetrieverCall) -> Self {
            Self::OperatorStateRetriever(value)
        }
    }
    impl ::core::convert::From<PauserCall> for BLSMockAVSDeployerCalls {
        fn from(value: PauserCall) -> Self {
            Self::Pauser(value)
        }
    }
    impl ::core::convert::From<PauserRegistryCall> for BLSMockAVSDeployerCalls {
        fn from(value: PauserRegistryCall) -> Self {
            Self::PauserRegistry(value)
        }
    }
    impl ::core::convert::From<ProxyAdminCall> for BLSMockAVSDeployerCalls {
        fn from(value: ProxyAdminCall) -> Self {
            Self::ProxyAdmin(value)
        }
    }
    impl ::core::convert::From<ProxyAdminOwnerCall> for BLSMockAVSDeployerCalls {
        fn from(value: ProxyAdminOwnerCall) -> Self {
            Self::ProxyAdminOwner(value)
        }
    }
    impl ::core::convert::From<RegistryCoordinatorCall> for BLSMockAVSDeployerCalls {
    ...
    impl ::core::convert::From<ServiceManagerCall> for BLSMockAVSDeployerCalls {
    ...
    impl ::core::convert::From<SlasherCall> for BLSMockAVSDeployerCalls {
        fn from(value: SlasherCall) -> Self {
            Self::Slasher(value)
        }
    }
    impl ::core::convert::From<SlasherImplementationCall> for BLSMockAVSDeployerCalls {
        fn from(value: SlasherImplementationCall) -> Self {
            Self::SlasherImplementation(value)
        }
    }
    impl ::core::convert::From<StakeRegistryCall> for BLSMockAVSDeployerCalls {
    ...
    impl ::core::convert::From<StrategyManagerMockCall> for BLSMockAVSDeployerCalls {
        fn from(value: StrategyManagerMockCall) -> Self {
            Self::StrategyManagerMock(value)
        }
    }
    impl ::core::convert::From<TargetArtifactSelectorsCall> for BLSMockAVSDeployerCalls {
        fn from(value: TargetArtifactSelectorsCall) -> Self {
            Self::TargetArtifactSelectors(value)
        }
    }
    impl ::core::convert::From<TargetArtifactsCall> for BLSMockAVSDeployerCalls {
        fn from(value: TargetArtifactsCall) -> Self {
            Self::TargetArtifacts(value)
        }
    }
    impl ::core::convert::From<TargetContractsCall> for BLSMockAVSDeployerCalls {
        fn from(value: TargetContractsCall) -> Self {
            Self::TargetContracts(value)
        }
    }
    impl ::core::convert::From<TargetInterfacesCall> for BLSMockAVSDeployerCalls {
        fn from(value: TargetInterfacesCall) -> Self {
            Self::TargetInterfaces(value)
        }
    }
    impl ::core::convert::From<TargetSelectorsCall> for BLSMockAVSDeployerCalls {
        fn from(value: TargetSelectorsCall) -> Self {
            Self::TargetSelectors(value)
        }
    }
    impl ::core::convert::From<TargetSendersCall> for BLSMockAVSDeployerCalls {
        fn from(value: TargetSendersCall) -> Self {
            Self::TargetSenders(value)
        }
    }
    impl ::core::convert::From<UnpauserCall> for BLSMockAVSDeployerCalls {
