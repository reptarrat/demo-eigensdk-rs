...
pub mod erc20_preset_fixed_supply {
    ...
    impl<M> ::core::fmt::Debug for ERC20PresetFixedSupply<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(ERC20PresetFixedSupply))
                .field(&self.address())
                .finish()
        }
    }
