pub use strategy_manager_storage::*;
...
pub mod strategy_manager_storage {
    ...
    pub static STRATEGYMANAGERSTORAGE_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct StrategyManagerStorage<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for StrategyManagerStorage<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for StrategyManagerStorage<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for StrategyManagerStorage<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for StrategyManagerStorage<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(StrategyManagerStorage))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> StrategyManagerStorage<M> {
        ...
        pub fn new<T: Into<::ethers::core::types::Address>>(
            ...
            Self(
                ::ethers::contract::Contract::new(
                    address.into(),
                    STRATEGYMANAGERSTORAGE_ABI.clone(),
                    client,
                ),
            )
        }
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            StrategyManagerStorageEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for StrategyManagerStorage<M> {
    ...
    impl ::ethers::contract::EthLogDecode for StrategyManagerStorageEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = DepositFilter::decode_log(log) {
                return Ok(StrategyManagerStorageEvents::DepositFilter(decoded));
            }
            if let Ok(decoded) = StrategyAddedToDepositWhitelistFilter::decode_log(log) {
                return Ok(
                    StrategyManagerStorageEvents::StrategyAddedToDepositWhitelistFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = StrategyRemovedFromDepositWhitelistFilter::decode_log(
                ...
                return Ok(
                    StrategyManagerStorageEvents::StrategyRemovedFromDepositWhitelistFilter(
                        decoded,
                    ),
                );
            }
            if let Ok(decoded) = StrategyWhitelisterChangedFilter::decode_log(log) {
                return Ok(
                    StrategyManagerStorageEvents::StrategyWhitelisterChangedFilter(
                        decoded,
                    ),
                );
            }
    ...
    impl ::core::fmt::Display for StrategyManagerStorageEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<DepositFilter> for StrategyManagerStorageEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for StrategyManagerStorageCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for StrategyManagerStorageCalls {
    ...
    impl ::core::fmt::Display for StrategyManagerStorageCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<DepositTypehashCall> for StrategyManagerStorageCalls {
        fn from(value: DepositTypehashCall) -> Self {
            Self::DepositTypehash(value)
        }
    }
    impl ::core::convert::From<DomainTypehashCall> for StrategyManagerStorageCalls {
        fn from(value: DomainTypehashCall) -> Self {
            Self::DomainTypehash(value)
        }
    }
    impl ::core::convert::From<AddSharesCall> for StrategyManagerStorageCalls {
        fn from(value: AddSharesCall) -> Self {
            Self::AddShares(value)
        }
    }
    impl ::core::convert::From<AddStrategiesToDepositWhitelistCall>
    for StrategyManagerStorageCalls {
    ...
    impl ::core::convert::From<DelegationCall> for StrategyManagerStorageCalls {
        fn from(value: DelegationCall) -> Self {
            Self::Delegation(value)
        }
    }
    impl ::core::convert::From<DepositIntoStrategyCall> for StrategyManagerStorageCalls {
    ...
    impl ::core::convert::From<EigenPodManagerCall> for StrategyManagerStorageCalls {
        fn from(value: EigenPodManagerCall) -> Self {
            Self::EigenPodManager(value)
        }
    }
    impl ::core::convert::From<GetDepositsCall> for StrategyManagerStorageCalls {
    ...
    impl ::core::convert::From<NoncesCall> for StrategyManagerStorageCalls {
        fn from(value: NoncesCall) -> Self {
            Self::Nonces(value)
        }
    }
    impl ::core::convert::From<RemoveSharesCall> for StrategyManagerStorageCalls {
    ...
    impl ::core::convert::From<SlasherCall> for StrategyManagerStorageCalls {
        fn from(value: SlasherCall) -> Self {
            Self::Slasher(value)
        }
    }
    impl ::core::convert::From<StakerStrategyListCall> for StrategyManagerStorageCalls {
